...
# Read the image
for fn in sorted(os.listdir('../img_align_celeba/CelebA')):
    print (fn)
    image = cv2.imread(os.path.abspath('../img_align_celeba/CelebA/' + fn))
    print(os.path.abspath('../img_align_celeba/CelebA/' + fn))
